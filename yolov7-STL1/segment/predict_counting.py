...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                if trk:
                    ...
                    if len(tracked_dets)>0:
                        ...
                        # print(bbox_xyxy,identities,categories)
            ...
            if len(centers)>0:
                ...
                for center in centers:
                    ...
                    if (center[0] > area1_pointA[0] and center[0] < area1_pointD[0]) and (center[1] > area1_pointA[1] and center[1] < area1_pointD[1]):
                        ...
                        # print('Kategori : '+str(cat))
                        # print("車："+str(carcounting))
                        # print('the_id:' + str(the_id))
                        # print("iden",identities,"\ncateg",categories)
            ...
            carcountingcolor = (0,255,0)
            carcountingthickness = 2
            carcountingfontScale = 1
            carcountingfont = cv2.FONT_HERSHEY_SIMPLEX
            carcountingorg = (20,480)
